...
tree_file <- "//files1.igc.gulbenkian.pt/folders/ANB/Pol/Expression/group_vs_solitary/00.ASR/tree_gs.nwk"
pheno_data_file <- "//files1.igc.gulbenkian.pt/folders/ANB/Pol/Expression/group_vs_solitary/00.ASR/template_gs_3cat.txt"
folder_out <- "//files1.igc.gulbenkian.pt/folders/ANB/Pol/Expression/group_vs_solitary/00.ASR/output/phytools/3cat/"
...
vector_states <- setNames(pheno$phenotype, pheno$Spp)
...
my_colors <- c("#BF9000", "#4472C4", "brown")
