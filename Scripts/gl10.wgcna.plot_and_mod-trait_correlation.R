...
# Make spp columns
meta_reg$Ornatipinnis <- ifelse(meta_reg$species == "Ornatipinnis", 1, 0)
meta_reg$Multifasciatus <- ifelse(meta_reg$species == "Multifasciatus", 1, 0)
meta_reg$Meeli <- ifelse(meta_reg$species == "Meeli", 1, 0)
meta_reg$phenotype <- ifelse(meta_reg$phenotype == "GL", 1, 0)
# Make datTraits
datTraits <- meta_reg[,c("phenotype", "Ornatipinnis", "Multifasciatus", "Meeli")]
